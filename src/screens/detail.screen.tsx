...
const DetailScreen = (props: DetailScreenProps) => {
  ...
  return (
    <SafeAreaView style={{backgroundColor: Colors.brown1}}>
      <Row height={50}>
        ...
        <Col size={5} justifyCenter>
          <ScaledText size={21} bold color={Colors.brown}>
    ...
    <Padder horizontal>
      <Col>
        <Row>
          <Col>
            <Padder horizontal>
              <Box borderRadius={10} fullWidth color={Colors.brown} height={45}>
                <Row>
                  <Col size={3} justifyCenter>
                    <Padder horizontal>
                      <Circle size={30} color={Colors.brown1}>
